  ...
  render() {
    ...
    return (
      <div className="App container-fluid" tabIndex="0" onKeyDown={this.movePlayer}>
        <div className="row">
          <div className="game-container col-12 col-xl-6" >
            <Game />
          </div>
          <div className="col-12 col-xl-6">
            <div className="log-container col-12">
              <GameLog />
            </div>
            <div className="infos-container col-12">
              <Infos />
            </div>
            <div className="legend-container col-12">
              <Legend />
            </div>
          </div>
        </div>
        <div className="row">
            <button className="buttons btn btn-danger" onClick={() => { this.startGame(1) }} >
              START
            </button>
        </div>
      </div>
